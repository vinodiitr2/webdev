...
<div id="help-panel" class="panel-left">
    ...
    <div class="panel-aside">
        ...
        <a class="button button-primary" href="<?php echo esc_url( 'https://demo.blossomthemes.com/blossom-travel/' ); ?>" title="<?php esc_attr_e( 'Visit the Demo', 'blossom-travel' ); ?>" target="_blank">
